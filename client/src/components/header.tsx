          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            >
              <span 
                ...
                className="text-white hover:text-primary transition-colors font-medium relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-primary after:left-0 after:-bottom-1 after:transition-all after:duration-300 hover:after:w-full flex items-center space-x-1 cursor-pointer"
              >
                <span>Services</span>
                    ...
                    <div className="grid grid-cols-3 gap-12">
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          <div>
                            <button 
                              onClick={() => handleServiceNavigation("/services/web-development")}
                              className="block text-primary hover:text-primary/80 transition-colors font-medium text-left"
                            >
                              ▶ Web Development
                            </button>
                          ...
                          <div>
                            <button 
                              onClick={() => handleServiceNavigation("/services/software-development")}
                              className="block text-primary hover:text-primary/80 transition-colors font-medium text-left"
                            >
                          ...
                          <div>
                            <button 
                              onClick={() => handleServiceNavigation("/services/app-development")}
                              className="block text-primary hover:text-primary/80 transition-colors font-medium text-left"
                            >
                              ▶ App Development
                            </button>
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          <div>
                            <button 
                              onClick={() => handleServiceNavigation("/services/data-engineering")}
                              className="block text-primary hover:text-primary/80 transition-colors font-medium text-left"
                            >
                              ▶ Data Engineering
                            </button>
                          ...
                          <div>
                            <button 
                              onClick={() => handleServiceNavigation("/services/cloud-engineering")}
                              className="block text-primary hover:text-primary/80 transition-colors font-medium text-left"
                            >
                              ▶ Cloud Engineering
                            </button>
                          ...
                          <div>
                            <button 
                              onClick={() => handleServiceNavigation("/services/mvp-development")}
                              className="block text-primary hover:text-primary/80 transition-colors font-medium text-left"
                            >
                              ▶ MVP Development
                            </button>
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          <div>
                            <button 
                              onClick={() => handleServiceNavigation("/services/devops")}
                              className="block text-primary hover:text-primary/80 transition-colors font-medium text-left"
                            >
                              ▶ DevOps
                            </button>
                          ...
                          <div>
                            <button 
                              onClick={() => handleServiceNavigation("/services/qa-testing")}
                              className="block text-primary hover:text-primary/80 transition-colors font-medium text-left"
                            >
                          ...
                          <div>
                            <button 
                              onClick={() => handleServiceNavigation("/services/it-consulting")}
                              className="block text-primary hover:text-primary/80 transition-colors font-medium text-left"
                            >
                              ▶ IT Consultation
                            </button>
