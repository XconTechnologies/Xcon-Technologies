      ...
      <div className="max-w-[1440px] mx-auto px-8 lg:px-16 py-16">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          ...
          <div className="flex justify-center items-center gap-8 flex-wrap">
            <a href="https://www.security.com/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-all duration-300 ease-in-out certification-badge">
            ...
            <a href="https://www.cloud-practitioner.com/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-all duration-300 ease-in-out certification-badge">
              <div className="w-20 h-20 flex items-center justify-center">
                <img 
            ...
            <a href="https://devops.com/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-all duration-300 ease-in-out certification-badge">
              <div className="w-20 h-20 flex items-center justify-center">
                <img 
                  src={devopsBadge} 
            ...
            <a href="https://www.developer.com/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-all duration-300 ease-in-out certification-badge">
              <div className="w-20 h-20 flex items-center justify-center">
                <img 
                  src={developerBadge} 
            ...
            <a href="https://www.solution-architect.com/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-all duration-300 ease-in-out certification-badge">
              <div className="w-20 h-20 flex items-center justify-center">
                <img 
            ...
            <a href="https://www.sysops.com/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-all duration-300 ease-in-out certification-badge">
              <div className="w-20 h-20 flex items-center justify-center">
                <img 
                  src={sysopsBadge} 
