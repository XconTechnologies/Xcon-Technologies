...
const jobListings = [
  ...
  },
  {
    ...
    requirements: [
      "5+ years of experience in proposal writing or business development",
  ...
  },
  {
    ...
    requirements: [
      "5+ years of experience in cold calling or telemarketing",
  ...
  },
  {
    ...
    requirements: [
      "5+ years of experience in email marketing",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Dialog open={showDetailsModal} onOpenChange={setShowDetailsModal}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto" aria-describedby="job-details-description">
          {selectedJob && (
            <>
              <DialogHeader>
